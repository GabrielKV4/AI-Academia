# Sprint 2: Evaluation Evidence

## Input Case 1: Microbiology Textbook
...
Visible light is comoposed of electromagnetic waves that exhibit wave-like properties, which are crucial for understanding microscopy. Key characteristics of light waves include:
- **Wavelength**: The distance between consecutive peaks of the wave
- **Amplitude**: The height of the peaks or depth of the troughs
- **Frequency**: The rate of vibration of the wave, indicating how many wavelengths occur within a specific time frame.
...
- Amplitude is the height of the wave peak.
...
### Original Input
For a p rogram that should run only as long as many conditions are true, you can define one variable that determines whether or not the entire program is active. This variable, called a flag, acts as a signal to the program. We can write our programs so they run while the flag is set to True and stop running when any of several events sets the value of the flag to False. As a result, our overall while statement needs to check only one condition: whether or not the flag is currently True. Then, all our other tests (to see if an event has occurred that should set the flag to False) can be neatly organized in the rest of the program.

### Baseline Summary
In programming, a flag is a variable used to control the execution of a program based on multiple conditions. The program runs while the flag is set to True and stops when any event changes the flag to False. This approach simplifies the overall while statement to check only the flag's status, while other conditions that may alter the flag can be managed separately within the program.

### ADHD Summary
**Learning Objectives:**
- Understanding the concept of a flag in programming.
- Learn how to control execution using a flag.
- Identify how to organize conditions in a program.

**Key Concepts:**
- A flag is a variable that signals if the program runs.
- The program runs while the flag is True.
- When the flag is False, the program stops.
- Only one condition checks if the flag is True.
- Other tests can organize events that change the flag.

**Recall Questions:**
1. What is the purpose of a flag in a program?
2. How does the program know when to stop running?
...
### Baseline Summary
Napolean Bonaparte (1769-1821), a French military leader and emperor, rose to prominence during the French Revolution. He seized power in a 1799 coup and crowned himself emperor in 1804. Known for his ambition and military stategy, he expanded his empire through successful campaigns against European coalitions. However, his 1812 invasion of Russia ended disastrously, leading to his abdication in 1814 and exile to Elba. He returned to power briefly in 1815 during the Hundred Days but was defeated at the Battle of Waterloo, resulting in his second abdication and exile to Saint Helena, where he died at 51.

### ADHD Summary
**Learning Objectives**
- Understanding the life of Napolean Bonaparte.
- Learn about his rise and fall as a leader.
- Recognize key events during his rule.

**Key Concepts**
- Napolean was born in 1769 on Corsica.
- He became a military leader during the French Revolution.
- He crowned himself emperor of France in 1804.
- His emperor expanded through successful military campaigns.
- He faced defeat in Russia and at Waterloo.
- Napolean died in exile on Saint Helena in 1821.

**Recall Questions**
1. What year did Napolean crown himself emperor?
2. Where was Napolean exiled after his defeat?
...
### Baseline Summary
Elon Musk experienced severe bullying as a child in South Africa, culminating in a hospital stay after a brutal attack. The emotional scars from his father's influence--a complex figure characterized by engineering talent and charisma--had a long lasting impact on Musk's psyche. He grew into a man with a mix of toughness and vulnerability, marked by mood swings, a high tolernace for risk, a craving for drama, and an intense sense of mission that could be destructive. By early 2022, following significant achievements with SpaceX and Tesla, Musk acknowledged his need to move away from a crsis-driven mindset that had dominated his life for many years.

### ADHD Summary
**Learning Objectives**
- Understand Elon Musk's childhood experiences.
- Explore the impact of his father's behavior.
- Analyze Musk's personality traits and their effects on his life.

**Key Concepts**
- Elon Musk faced severe bullying as a child.
- He was hospitalized after a violent incident with bullets.
- His father's influence shaped Musk's emotional state.
- Musk exhibits intense mood swings and risk-taking behavior.
- He recognizes the need to change his crisis-driven mindset.

**Recall Questions**
1. What traumatic event did Elon Musk experience as a child?
...
| Reading Level | Avg Sentence Length | Avg Paragraph Length | Compliance Score |
| ------------- | ------------------- | -------------------- | ---------------- |
| 14.4265       | 26.25               | 105                  | 20%              |

**ADHD**

| Reading Level | Avg Sentence Length | Avg Paragraph Length | Compliance Score |
| ------------- | ------------------- | -------------------- | ---------------- |
| 8.0542        | 8.4167              | 16.8333              | 90%              |
...
### Baseline Summary
The study addresses the mystery of how supermassive black holes, which can be millions to billions of times the mass of the Sun, grew so rapidly in the early universe. Current theories suggest they originated in the dust-rich cores of starburst galaxies, later emerging as luminous quasars surrounding gas and dust. While both starburst galaxies and quasars have been detected, rapidly growing black holes in early star-forming galaxies had not been observed until now. The accretion disk of a massive black hole is expected to emit bright UV and X-ray light. Hubble detected UV light in the galaxy GNz7q, but X-ray emissions were not found, indicating that the core of the accretion disk, where X-rays are produced, remains obscured by dust, while the outer region, emitting UV light, is becoming visible. This supports the idea of a rapidly growing black hole still hidden wihin its dusty host galaxy.

### ADHD Summary
**Learning Objectives**
- Understanding how supermassive black holes form.
- Learn about the role of starburst galaxies.
- Recognize the significant of UV and X-ray light in black hole studies.

**Key Concepts**
- Supermassive black holes are very massive, millions to billions of times the Sun's mass.
- They likely form in starburst galaxies with lots of star formation.
- Quasars are bright objects that emerge from these black holes.
- Oberservations show UV light from black holes, but X-ray light can be hidden.
- Dusty cores can observed parts of the black hole's accretion disk.

**Recall Questions**
1. What is a quasar, and how is it related to black holes?
2. Why might X-ray light not be detected in some black holes?
...
### Baseline Summary
The study material outlines the interaction between two cognitive systems, referred to as System 1 and System 2. System 1 operates automatically and generates suggestions such as impressions and intuitions, while System 2 functions in a low-effort mode, engaging more actively when System 1 encounters difficulties. System 2 is mobilized to address questions that System 1 cannot answer and is responsible for monitoring behavior and controlling impulses.

The efficiency of this division of labor allows for minimal effort and optimized performance, as System 1 is adept at handling familiar situations and making quick predictions. However, System 1 has inherent biases and is prone to systematic errors, especially in logic and statistics, and cannot be turned off. Overall, while System 1 typically guides thoughts and actions, System 2 intervenes when challenges arise, ensuring a balance between automatic responses and deliberate reasoning.

### ADHD Summary
**Learning Objectives**
- Understand the roles of System 1 and System 2.
- Identify how these systems interact during thinking.
- Recognize the limitations of System 1 and System 2.

**Key Concepts**
- System 1 operates automatically and quickly.
- System 2 engages when System struggles or is surprised.
- System 1 generates impressions and intuitions for System 2.
- System 2 monitors behavior and controls actions.
...
| Reading Level | Avg Sentence Length | Avg Paragraph Length | Compliance Score |
| ------------- | ------------------- | -------------------- | ---------------- |
| 16.4357       | 23.3333             | 70                   | 30%              |

**ADHD**

| Reading Level | Avg Sentence Length | Avg Paragraph Length | Compliance Score |
| ------------- | ------------------- | -------------------- | ---------------- |
| 8.3165        | 8.4167              | 16.8333              | 90%              |
...
### Baseline Summary
Neural networks are inspired by biological neurons in the human brain, which communicate via electrical signals. The concept began in 1943 with McCulloch and Pitts' mathematical model of a neuron, followed by Rosenblatt's 1958 perceptron, an early algorithm for pattern recognition. Neural netowrks, like the perceptron, process inputs to make decisions, exemplified by spam detection. In this process, features from an email (e.g., specific words) are inputted into the network. Early neurons assess the significance of these featuers, while later layers synthesize into higher-level cues. The final layer calculates the probability of the email being spam, flagging it if the probability exceeds a threshold.

Key to this process are weights and biases: weights determine the influence of each input feature (e.g., prioritizing "prize" over "hello"), while biases adjust the decision threshold. Through training, the network fine-tunes these parameters to improve prediction accuracy. Mathematically, a neural network learns a function f(X) that maps an input vector X to a predicted response Y. Their layered architecture and capacity for nonlinear transformations set neural networks apart from traditional machine learning algorithms.
...
- Inputs like words help detect spam emails.
- Weights control the influence of each input feature.
...
| Reading Level | Avg Sentence Length | Avg Paragraph Length | Compliance Score |
| ------------- | ------------------- | -------------------- | ---------------- |
| 13.0078       | 13.1429             | 90                   | 20%              |

**ADHD**

| Reading Level | Avg Sentence Length | Avg Paragraph Length | Compliance Score |
| ------------- | ------------------- | -------------------- | ---------------- |
| 7.4531        | 8.3333              | 16.6667              | 100%             |
...
### Baseline Summary
The study material discusses the historical power dynamics in Mongolia, focusing on key tribes and leaders. The Xiongnu, a confederated empire, engaged in prolonged conflict with early China before disbanding in 48 CE. The Khitan established the Liao dynasty (9070-1125) in Manchuria and North China, forming an alliance with a tribal group called All the Mongols. After the Liao's fll, the Tatars allied with the Juchen, the Khitan's successors. Genghis Khan, who rose to power within the All the Mongols league and was declared khan in 1206, expanded Mongol territory through campaigns from 1207 to 1227, reaching as far west as European Russia and capturing Bejing in 1215. Bu his death, the Mongol Empire spanned a vast area of Asia. The Mongols' military success was attributed to their mounted archers, known for their speed and mobility.

### ADHD Summary
**Learning Objectives**
- Understand the key tribes in Mongolia's history.
- Learn about Genghis Khan and his conquests.
- Recognize the significance of Mongol military strategy.
...
- Mongol campaigns expanded their territory from Europe to northern China.
- Mongol military success relied on fast, mobile mounted arches.

**Recall Questions**
1. Who was Genghis Khan and what did he achieve?
2. What was the role of mounted archers in the Mongol empire?
...
### Baseline Summary
Parkinson's disease (PD) is a progressive neurodegenerative disorder marked by tremor, rigidity, bradykinesia, and postural instability, first described by James Parkinson in 1817. It is the second most common neurodegenerative disease after Alzheimer's, with a prevalence of 0.5-1% in individuals aged 65-59, increasing to 1-3% in those over 80. The prevalence and incidence of PD are projected to rise by over 30% by 2030 due to an aging population, leading to significant societal and economic impacts. Pathogically, PD is characterized by the loss dopaminergic neurons in the nigrostriatal pathway, but it also affects other neural regions, contributing to its heterogeneity. Diagnosis relies on clinical symptoms, requiring two of the following: resting tumor, bradykinesia, rigidity, or postural instability; a definitive diagnosis necessaitates histopathological confirmation through the identification of a-synuclein-containing Lewy bodies. Current treatements focus on sympotimatic relief, primarily through dopamine restoration or targeting other neurotransmitters for associated symptoms like depression. Research is ongoing for novel therapies aimed at slowing nerodegeneration and replenishing lost dopmainergic cells, with potential for developing disease-modifying treatemnts as understanding of PD pathgensis improves.
...
**Key Concepts**
- Parkison's diease is a progressive neurodegenerative disorder.
- Common symptoms include tremor, rigidity, and bradykinesia,
- Diagnosis requires two clincial features: resting tumor, bradykinesia, rigidity, or postural instability.
...
| Reading Level | Avg Sentence Length | Avg Paragraph Length | Compliance Score |
| ------------- | ------------------- | -------------------- | ---------------- |
| 18.8388       | 22.25               | 177                  | 20%              |

**ADHD**

| Reading Level | Avg Sentence Length | Avg Paragraph Length | Compliance Score |
| ------------- | ------------------- | -------------------- | ---------------- |
| 11.5014       | 8.1667              | 16.3333              | 90%              |
